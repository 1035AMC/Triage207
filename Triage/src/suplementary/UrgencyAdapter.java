 ...
 */
public class UrgencyAdapter extends ArrayAdapter<Patient> {
	// View lookup cache
	 ...
	 */
	public UrgencyAdapter(Context context, ArrayList<Patient> patients) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		viewHolder.healthCard.setText("" + patient.calculateUrgency());
